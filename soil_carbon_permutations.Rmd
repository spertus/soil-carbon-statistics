...
#compute separate p_values for each
p_values <- c(t2p(observed_TotC, permutations_TotC, alternative = "two-sided"),
              t2p(observed_percC, permutations_percC, alternative = "two-sided"),
              t2p(observed_percN, permutations_percN, alternative = "two-sided"),
              t2p(observed_clay, permutations_clay, alternative = "two-sided"))

#combination p-value
npc(p_values, distr = cbind(permutations_TotC, permutations_percC, permutations_percN, permutations_clay), combine = "fisher", alternatives = "two-sided")
```

...
basicPage(
  ...
  sidebarPanel(
              ...
              numericInput("C_0_budget", "Input total fixed costs (\\(\\mbox{cost}_0\\))", value = 0),
  ...
  mainPanel(
    h3("Results"),
    span(textOutput("budget"), style="color:blue; font-size:20px"),
    span(textOutput("n"), style="color:blue; font-size:20px"),
    span(textOutput("k"), style="color:blue; font-size:20px")
  )
)

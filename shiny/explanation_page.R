...
basicPage(
  ...
  h6("Select an app from the drop down menu above. More information about each app can be found on the corresponding page."),
  ...
  h6("For more details refer to Spertus (2021) \"Optimal Sampling and Assay for Estimating Soil Organic Carbon\", available at:"), 

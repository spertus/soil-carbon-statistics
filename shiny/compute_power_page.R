...
basicPage(
  ...
  sidebarPanel(
             ...
             numericInput("sigma_p_1_power", "Input spatial heterogeneity of %SOC in plot 1 (\\(\\sigma_{p1}\\))", value = 1.00),
             numericInput("sigma_p_2_power", "Input spatial heterogeneity of %SOC in plot 2 (\\(\\sigma_{p2}\\))", value = 1.00),
             numericInput("sigma_delta_power", "Input assay variability (\\(\\sigma_\\delta\\))", value = 0),
  ...
  mainPanel(
    h3("Results"),
    span(textOutput("power_effectsize"), style="color:blue; font-size:20px"),
